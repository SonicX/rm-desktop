...
function saveWAV(audioBuffers, filename) {
  ...
  offset += 4;
  buffer.writeUInt32LE(36 + totalSize, offset);
  offset += 4;
  ...
  offset += 4;
  buffer.writeUInt32LE(sampleRate * channels * 4, offset);
  offset += 4;
  buffer.writeUInt16LE(channels * 4, offset);
  offset += 2;
